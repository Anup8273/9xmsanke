...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "9𝘹𝘮 ✘ 𝐌ʋsɩƈ")
OWNER_ID = list(map(int, getenv("OWNER_ID", "5379949226").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Anup8273/9xmsanke")
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/ac6a38881941065b8a1fb.jpg")

PLAYLIST_IMG_URL = "https://graph.org/file/ac6a38881941065b8a1fb.jpg"
